...
public class ViewResults extends Document {
	 ...
	 * @param obj
	 */
	ViewResults(View calledView, org.json.JSONObject obj) {
		super(obj);
	...
	public List<Document> getResults() {
		org.json.JSONArray ar = getJSONObject().getJSONArray("rows");


		List<Document> docs = new ArrayList<>(ar.length());
		log.debug("==============ar.getString(i)================");
	...
	public JSONArray getResultsJSONArray() {
		return getJSONObject().getJSONArray("rows");
	}
